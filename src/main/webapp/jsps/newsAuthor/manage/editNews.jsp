...
<body>
	...
	<form action="<c:url value="/NewsServlet?method=editNews&newsId=${news.newsId}&order=asc" />"
		...
		<table width="600" align="center" border="1">
			<tbody>
				...
				<tr>
					<td>日期</td>
					<td><input type="datetime-local" name="newsTime" id="newsTime" value="${news.newsTime}"></td>
				</tr>
				<tr>
					<td colspan="2">
						<div>
