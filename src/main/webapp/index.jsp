...
<head>
<meta charset="UTF-8">
<title>jquery支持回复点赞的评论表单代码演示_大头网</title>
...
<body>
	...
	<div class="commentAll">
		...
		<div class="reviewArea clearfix">
			<textarea name="content" class="content comment-input"
				placeholder="请输入内容..." onkeyup="keyUP(this)"></textarea>
			...
			<div class="comment-show-con clearfix">
				...
				<div class="comment-show-con-list pull-left clearfix">
					<div class="pl-text clearfix">
						<a href="#" class="comment-size-name">${session_user.name} </a> <span
							class="my-pl-con">&nbsp;${comment.content}</span>
					</div>
					<div class="date-dz">
						<span class="date-dz-left pull-left comment-time">2017-6-6
							11:11:39</span>
	...
	<script type="text/javascript">
		$('.commentAll').on('click', '.plBtn', function() {
			...
			console.log(oSize);
			//动态创建评论模块
			oHtml = '<div class="comment-show-con clearfix"><div class="comment-show-con-img pull-left"><img src="/${session_user.headIconUrl}"></div> <div class="comment-show-con-list pull-left clearfix"><div class="pl-text clearfix"> <a href="#" class="comment-size-name">David Beckham : </a> <span class="my-pl-con">&nbsp;' + oSize + '</span> </div> <div class="date-dz"> <span class="date-dz-left pull-left comment-time">' + now + '</span> <div class="date-dz-right pull-right comment-pl-block"><a href="javascript:;" class="removeBlock">删除</a> <a href="javascript:;" class="date-dz-pl pl-hf hf-con-block pull-left">回复</a> <span class="pull-left date-dz-line">|</span> <a href="javascript:;" class="date-dz-z pull-left"><i class="date-dz-z-click-red"></i>赞 (<i class="z-num">666</i>)</a> </div> </div><div class="hf-list-con"></div></div> </div>';
    ...
    $('.comment-show').on('click','.pl-hf',function(){
        ...
        var fhHtml = '<div class="hf-con pull-left"> <textarea class="content comment-input hf-input" placeholder="" onkeyup="keyUP(this)"></textarea> <a href="<c:url value='/NewsServlet?method=addReplyPre&newsId=${news.newsId}&commentId=${comment.commentId}&pc=${news.pb.pc}'/>" class="hf-pl">评论</a></div>';
        //显示回复
